...
async def process_address(message: types.Message, state: FSMContext):
    ...
    kb = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="✅ Confirm", callback_data="confirm_withdraw")], [InlineKeyboardButton(text="❌ Cancel", callback_data="cancel_withdraw")]])
